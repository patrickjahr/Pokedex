...
namespace PokeDex.UwpApp.Services
{
    public class NavigationService : INavigationService
    {
        ...
        {
            { NavigationTarget.MAIN_PAGE, typeof(MainPage) },
            { NavigationTarget.POKEMON_OVERVIEW_PAGE, typeof(PokemonOverviewPage) },
            { NavigationTarget.POKEMON_DETAIL_PAGE, typeof(PokemonDetailPage) },
        };
        ...
        {
            ClearBackStack();
            Navigate(NavigationTarget.MAIN_PAGE);
        }
